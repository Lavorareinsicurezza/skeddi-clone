        ...
        <form action="{{ route('admin.companies.store') }}" method="POST">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    <div>
                        <label class="block text-sm font-bold text-gray-900 mb-2">{{ __('lang.company_name') }} <span
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-900 mb-2">{{ __('lang.vat_number') }} <span
                                class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-900 mb-2">{{ __('lang.registered_office') }}
                            </label>
                    ...
                    {{-- <div>
                        <label
                            class="block text-sm font-bold text-gray-900 mb-2">{{ __('lang.operating_office') }}</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-900 mb-2">{{ __('lang.company_contact_person') }}
                            </label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <div>
                        <label
                            class="block text-sm font-bold text-gray-900 mb-2">{{ __('lang.head_of_prevention_service') }}
                            </label>
                    ...
                    <div>
                        <label
                            class="block text-sm font-bold text-gray-900 mb-2">{{ __('lang.workers_safety_representative') }}
                            </label>
                    ...
                    <div>
                        <label
                            ...
                            <input type="checkbox" name="subject_to_cpi" value="1"
                                class="w-6 h-6 appearance-none bg-white border-2 border-gray-400 rounded-full cursor-pointer checked:border-[5px] checked:border-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                        </label>
                    </div>
                    <div>
                ...
                <div class="mb-6">
                    <h3 class="text-sm font-bold text-gray-900 mb-4">{{ __('lang.external_professional_contacts') }}
                    </h3>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="notes" rows="4" placeholder="{{ __('lang.enter_additional_notes') }}"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none">{{ old('notes') }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div>
                        <label
                            class="border border-gray-300 rounded-lg px-4 py-3 flex items-center justify-between cursor-pointer hover:bg-gray-50 has-[:checked]:border-blue-700 has-[:checked]:bg-blue-50">
                            <span
                                class="text-sm font-bold text-gray-900">{{ __('lang.send_deadline_notification') }}</span>
                ...
                <!-- Contacts Selection -->
                {{-- <div>
                    <h3 class="text-sm font-bold text-gray-900 mb-4">{{ __('lang.contacts_select_at_least_one') }}
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        @foreach ($userEmails as $email)
                            <div>
                                <label
                                    class="border @error('contacts') border-red-500 @else border-gray-300 @enderror rounded-lg px-4 py-3 flex items-center justify-between cursor-pointer hover:bg-gray-50 has-[:checked]:border-blue-700 has-[:checked]:bg-blue-50">
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-4 mb-6">
                    <div class="text-end">
                        <button type="submit"
                            class="bg-blue-700 text-white px-6 py-3 rounded-lg mt-6">{{ __('lang.save') }}</button>
                    </div>
                </div>
