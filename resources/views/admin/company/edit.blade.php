        ...
        <form action="{{ route('admin.companies.update', $company->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        <input type="email" name="accountant_email" value="{{ old('accountant_email', $company->accountant_email) }}" placeholder="{{ __('lang.email') }}"
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <input type="text" name="labor_consultant_name" value="{{ old('labor_consultant_name', $company->labor_consultant_name) }}" placeholder="{{ __('lang.name') }}"
                            class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#0C3183] focus:border-transparent">
                    </div>
                    <div>
                    ...
                    <div>
                        <input type="email" name="labor_consultant_email" value="{{ old('labor_consultant_email', $company->labor_consultant_email) }}" placeholder="{{ __('lang.email') }}"
