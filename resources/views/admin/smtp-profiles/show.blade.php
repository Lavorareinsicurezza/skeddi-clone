    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label class="block text-sm font-bold text-gray-900 mb-1">Nome Profilo</label>
                    <p class="text-base text-gray-900">{{ $smtpProfile->name }}</p>
                </div>
                <div>
                    <label class="block text-sm font-bold text-gray-900 mb-1">Host SMTP</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label class="block text-sm font-bold text-gray-900 mb-1">Porta</label>
                    <p class="text-base text-gray-900">{{ $smtpProfile->port }}</p>
                </div>
                <div>
                    <label class="block text-sm font-bold text-gray-900 mb-1">Crittografia</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label class="block text-sm font-bold text-gray-900 mb-1">Username</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label class="block text-sm font-bold text-gray-900 mb-1">Indirizzo mittente (From Address)</label>
                    <p class="text-base text-gray-900">{{ $smtpProfile->from_address ?: '-' }}</p>
                </div>
                <div>
                    <label class="block text-sm font-bold text-gray-900 mb-1">Nome mittente (From Name)</label>
            ...
            <!-- Row 5 -->
            <div class="mb-6">
                <label class="block text-sm font-bold text-gray-900 mb-1">Reply-To</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-gray-200">
                <div>
                    <label class="block text-sm font-bold text-gray-900 mb-1">Creato il</label>
                    <p class="text-base text-gray-900">{{ $smtpProfile->created_at->format('d/m/Y H:i') }}</p>
                </div>
                <div>
                    <label class="block text-sm font-bold text-gray-900 mb-1">Ultimo aggiornamento</label>
