...
@section('content')
    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="mb-6 flex items-center justify-between">
            <h1 class="text-2xl font-bold text-gray-900">{{ __('lang.create_user') }}</h1>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-900 mb-2">{{ __('lang.password') }}</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label
                                ...
                                <div class="flex-1">
                                    <span
                                        class="text-sm font-bold text-gray-900 block">{{ __('lang.company_rsvp') }}</span>
                                    <span
                                        class="text-xs text-gray-900 mt-1 block">{{ __('lang.permission_modify_company_rsvp') }}</span>
                                </div>
                        ...
                        <div>
                            <label
                                ...
                                <div class="flex-1">
                                    <span
                                        class="text-sm font-bold text-gray-900 block">{{ __('lang.training_plan') }}</span>
                                    <span
                                        class="text-xs text-gray-900 mt-1 block">{{ __('lang.training_plan_access') }}</span>
                                </div>
                        ...
                        <div>
                            <label
                                ...
                                <div class="flex-1">
                                    <span
                                        class="text-sm font-bold text-gray-900 block">{{ __('lang.health_surveillance') }}</span>
                                    <span
                                        class="text-xs text-gray-900 mt-1 block">{{ __('lang.health_surveillance_access') }}</span>
                                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <!-- Visible Companies -->
                    <div>
                        <h3 class="text-sm font-bold text-gray-900 mb-4">{{ __('lang.visible_companies') }} <span
