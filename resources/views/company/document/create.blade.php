            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        <label> &nbsp; </label>
                        <label
                            class="border w-[100%] border-gray-300 rounded-lg px-4 py-3 flex items-center justify-between cursor-pointer hover:bg-gray-50 has-[:checked]:border-[#0C3183] has-[:checked]:bg-blue-50">
                            <span class="text-sm font-medium text-gray-800">{{ __('lang.to_schedule') }}</span>
                            <input type="checkbox" name="to_schedule" value="1"
                                {{ old('to_schedule', $document->to_schedule ?? false) ? 'checked' : '' }}
